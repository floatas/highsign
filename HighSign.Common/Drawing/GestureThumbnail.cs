...
namespace HighSign.Common.Drawing
{
	public class GestureThumbnail
	{
		...
		private Pen _DrawingPen = new Pen(Color.Blue, 3);
		...
		{
			get { return _WithArrow; }
			set { _WithArrow = value; }
		}

		public int DrawingWidth
		{
			get { return Convert.ToInt32(Math.Floor(_DrawingPen.Width)); }
			set { _DrawingPen = new Pen(_DrawingPen.Color, value); }
		}

		public Color DrawingColor
		{
			get { return _DrawingPen.Color; }
			set { _DrawingPen = new Pen(value, _DrawingPen.Width); }
		}
		...
		public GestureThumbnail(PointF[] Points, Size Size, bool WithArrow, int DrawingWidth, Color DrawingColor) : this(Points, Size, WithArrow)
		{
